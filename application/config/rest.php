...
|
*/
$config['rest_response_data_name'] = 'data';

/*
|--------------------------------------------------------------------------
| REST user identity Field Name
|--------------------------------------------------------------------------
|
| The field name for the user to check associated api key
|
*/
$config['rest_user_identity_field'] = 'userID';
/*
|--------------------------------------------------------------------------
...
|
*/
 $config['auth_override_class_method']['authentication']['login']           = 'none';
 $config['auth_override_class_method']['authentication']['register']        = 'none';
 //$config['auth_override_class_method']['authentication']['logout']        = 'none';
 $config['auth_override_class_method']['authentication']['socialLogin']     = 'none';
 $config['auth_override_class_method']['authentication']['isUserNameExist'] = 'none';
 $config['auth_override_class_method']['authentication']['isUserEmailExist']= 'none';
 $config['auth_override_class_method']['authentication']['forgetPassword']  = 'none';
 $config['auth_override_class_method']['authentication']['resendotp']       = 'none';
 $config['auth_override_class_method']['authentication']['changePassword']  = 'none';
 $config['auth_override_class_method']['authentication']['verifyOtp']  = 'none';
 $config['auth_override_class_method']['authentication']['subscriptionPlan']  = 'none';
...
/*
|--------------------------------------------------------------------------
| REST user id Field Name in key table
|--------------------------------------------------------------------------
|
| The field name for the user in key table
|
*/
$config['rest_key_user_column'] = 'user_id';
/*
|--------------------------------------------------------------------------
